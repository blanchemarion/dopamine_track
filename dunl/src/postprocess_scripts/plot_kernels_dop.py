...
def init_params():
    ...
    parser.add_argument(
        ...
        type=str,
        help="res path",
        default= [f"dopamine/results/dopamine_photometry_Day{i}_numwindow1_roi16_kernellength30_1kernels_1000unroll_2025_08_06_16_10_28" for i in range(1,4)]  
        #[f"dopamine/results/dopamine_photometry_numwindow1_roi{i}_kernellength30_1kernels_1000unroll_2025_02_20_15_49_52" for i in range(19)]  
...
def plot_kernel(kernels, params, out_path, idx):
    ...
    plt.savefig(
        os.path.join(out_path, f"kernel_16_Day{idx+1}.png"),
        bbox_inches="tight",
        pad_inches=0.02,
    )
    plt.show()
